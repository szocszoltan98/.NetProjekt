...
INSERT INTO `tickets` (`id`, `valid_from`, `valid_until`, `nr_of_entries`, `nr_of_entries_day`, `hour_from`, `hour_until`, `weekend`, `barcode`) VALUES
...
INSERT INTO `users` (`FirstName`, `LastName`, `Email`, `PhoneNumber`, `birthday`, `admin`, `barcode`, `active`) VALUES
